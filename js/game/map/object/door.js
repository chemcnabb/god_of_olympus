...
Olympus.Map.Object.Door = function(game, sprite) {
    this.game = game;
    this.sprite = sprite;
...
Olympus.Map.Object.Door.init = function(game) {
    Olympus.Map.Object.Door.sound_open = game.add.audio('doorOpen_1');
    Olympus.Map.Object.Door.sound_close = game.add.audio('doorClose_4');
};

Olympus.Map.Object.Door.prototype = {
    isOpen: function() {
        return this.delta !== 0;
    },
    ...
    overlapTrigger: function(player) {
        ...
        if (wasOpen !== isOpen) {
            if (wasOpen) {
                Olympus.Map.Object.Door.sound_close.play();
            } else {
                Olympus.Map.Object.Door.sound_open.play();
            }
        }
    }
};
